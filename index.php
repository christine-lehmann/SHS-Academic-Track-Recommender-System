...
<div class="container">
  <div class="jumbotron">
    ...
    <h1>Academic Track Recommender</h1>
    <h4>Answer these questions to get advice about the adademic track/strand you should pursue!</h4>
  </div>
  <br>
  <form id="all-questions">
    ...
    <div class="radio">
      <div class="single-question">
        ...
        <div class="radio">
          <div class="single-question">
            <p class="question-text">4. The price of the carpet is 240$. After the price hike, the carpet cost 420$. \nBy how many percent was the price of the carpet increased? </p>
            <label>
        ...
        <div class="radio">
          <div class="single-question">
            <p class="question-text">10. The laptop cost 1000$ before the discount, and 320$ after the discount. \nHow many percent the price of the laptop was reduced? </p>
            <label>
...
<div class="container" id="recommendation">
  ...
  <p class="top-result" id="STEM"><a href="https://docs.oracle.com/javase/8/docs/technotes/guides/language/index.html">STEM</a></p>
  <p class="top-result" id="ABM"><a href="https://www.javascript.com/">ABM</a></p>
  <p class="top-result" id="HUMSS"><a href="https://kotlinlang.org/">HUMSS</a></p>
  <p class="top-result" id="ICT"><a href="https://www.python.org/">ICT</a></p>
  <p class="top-result" id="IA"><a href="https://docs.oracle.com/javase/8/docs/technotes/guides/language/index.html">IA</a></p>
  <p class="top-result" id="HE"><a href="https://www.javascript.com/">HE</a></p>
  <p class="top-result" id="GAS"><a href="https://www.python.org/">GAS</a></p>
  <p id="gsa-scores"></p>
</div>
